// <copyright file="FixtureMethodScenarioOutlineNoStepsNUnitBehaviour.cs" company="Erratic Motion Ltd">
...
namespace ErraticMotion.Test.Tools.Spock.Elements
{
    ...
    [TestFixture]
    public class FixtureMethodScenarioOutlineNoStepsNUnitBehaviour : FixtureMethodScenarioOutlineNoStepsBase
    {
        ...
        [Where(24, "[Ignore(\"Generated from feature file, waiting for implementation\")]")]
        [Where(25, "[System.CLSCompliant(false)]")]
        [Where(26, "[TestCase(500M, 50M, 50M, 450M)]")]
        [Where(27, "[TestCase(500M, 100M, 100M, 400M)]")]
        [Where(28, "[TestCase(500M, 200M, 200M, 300M)]")]
