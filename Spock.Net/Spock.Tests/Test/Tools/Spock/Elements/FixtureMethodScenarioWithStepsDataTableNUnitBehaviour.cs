// <copyright file="FixtureMethodScenarioWithStepsDataTableNUnitBehaviour.cs" company="Erratic Motion Ltd">
...
namespace ErraticMotion.Test.Tools.Spock.Elements
{
    ...
    [TestFixture]
    public class FixtureMethodScenarioWithStepsDataTableNUnitBehaviour : FixtureMethodScenarioWithStepsBase
    {
